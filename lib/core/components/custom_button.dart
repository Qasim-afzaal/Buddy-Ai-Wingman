...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({super.key, this.onTap, required this.buttonText, this.backGroundColor, this.textColor});
      ...
      onTap: onTap,
        child: Container(
          ...
          decoration: BoxDecoration(
            border: backGroundColor != null ? Border.all(color: AppColors.blackColor) : null,

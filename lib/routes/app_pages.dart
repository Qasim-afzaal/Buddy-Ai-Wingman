...
import 'package:buddy_ai_wingman/pages/sparkd_lines/sparkd_lines_binding.dart';
import 'package:buddy_ai_wingman/pages/sparkd_lines/sparkd_lines_response/sparkd_lines_response.dart';
import 'package:buddy_ai_wingman/pages/sparkd_lines/sparkd_lines_response/sparkd_lines_response_binding.dart';
...
import 'package:buddy_ai_wingman/pages/start_sparkd/start_sparkd_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: _Paths.buddy_ai_wingman_LINES_RESPONSE, page: () => const buddy_ai_wingmanLinesResponsePage(), binding: buddy_ai_wingmanLinesResponseBinding()),
    GetPage(name: _Paths.buddy_ai_wingman_LINES, page: () => const buddy_ai_wingmanLinesPage(), binding: buddy_ai_wingmanLinesBinding()),
    GetPage(name: _Paths.START_buddy_ai_wingman, page: () => const Startbuddy_ai_wingmanPage(), binding: Startbuddy_ai_wingmanBinding()),
    GetPage(name: _Paths.TERMS_CONDITION, page: () => const TermsConditionPage(), binding: TermsConditionBinding()),
    GetPage(name: _Paths.NEW, page: () => NewGatherChatPage(),binding:   NewGatherChatInfoBinding(), ) ,
        GetPage(name: _Paths.NEW2, page: () => ChatPage2(),binding:   Chat2Binding(), ) ,
  ];
}

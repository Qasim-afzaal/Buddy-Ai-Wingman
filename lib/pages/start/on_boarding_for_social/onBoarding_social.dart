...
class OnBoardingSocialPage extends StatelessWidget {
  const OnBoardingSocialPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<OnBoardingSocialController>(
        init: OnBoardingSocialController(),
        builder: (controller) {
          return Scaffold(
            body: SafeArea(
              child: Column(
